...
checkpoint:
  ...
  gray_areas_resolved:
    ...
    - topic: "core scope"
      decision: "training plan generation is core; garage is a bonus add-on"
    - topic: "persona scope"
      decision: "hobbyist niche — road cyclists who already know their FTP"
    - topic: "key insight"
      decision: "Strava and TrainingPeaks analyse the past; WattWise prescribes the future"
